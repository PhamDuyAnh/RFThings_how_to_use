...
// const char* password = "Da09Ha23Du23Ho09";
...
void setupOTA() {
  ...
  ArduinoOTA.setHostname(("RAK-NODE-" + String(NODE)).c_str());
...
#ifdef OTA
  ArduinoOTA.handle();
  //scanWifiToConnectLoop();
#endif
}
#endif


void scanWifiToConnect() {
