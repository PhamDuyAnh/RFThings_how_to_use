...
*/
//#define Titops  // Titops MQTT Broker not use TCP SSL encryption, undefine TCP_SSL when using Titops MQTT
#define TCP_SSL
...
// //#ifndef WIFI_MANAGER
// #ifdef Titops
// //#define TCP_SSL  // MQTT Broker using TCP SSL encryption
...
// //#define TCP_SSL  // MQTT Broker using TCP SSL encryption
// int mqtt_port = 8883;
// // char* mqtt_server = "8fcfc29c35f04789a706f34250c4fc85.s2.eu.hivemq.cloud";  // replace with your HiveMQ Cluster URL
// // char* mqtt_username = "0908984010";                                         // replace with your Username
// // char* mqtt_password = "DuyAnh@0908984010";                                  // replace with your Password
// char mqtt_server[60] = "8fcfc29c35f04789a706f34250c4fc85.s2.eu.hivemq.cloud";  // replace with your HiveMQ Cluster URL
// char mqtt_username[32] = "0908984010";                                         // replace with your Username
// char mqtt_password[32] = "DuyAnh@0908984010";                                  // replace with your Password
// #endif
// //#endif
// int mqtt_tcpssl = 1;  // 1 use TCP SSL, 0 not use TCP SSL
...
void loopMQTT() {
  ...
  // unsigned long now = millis();
  // if (now - lastMsg > publishDelay) {
  //   lastMsg = now;
  //   publishMessage("ckd/iot/ldr", String(ldr));
  // }
}
...
#endif
    //publishMessage(mqtt_TopicPrefix + "test", "1");
    // mqtt.publish(topic_ldr, String(ldr).c_str());
    // //mqtt.publish("DocTest/ChipID", String(ESP.getChipId()).c_str());
    // // … and resubscribe
    // mqtt.subscribe(topic_ldr);
    // mqtt.subscribe(topic_ledr);
    // mqtt.subscribe(topic_ledb);
    // mqtt.subscribe(topic_ledg);
  }
  return mqtt.connected();
}
// void publishMessageRefix(String refix, String topic, String payload) {
//   String _s = refix + topic;
//   publishMessage(_s.c_str(), payload);
//   // Serial.print("-->");
//   // Serial.println(_s);
// }
